    ...
    <div class="home-page container">
        ...
        {{-- ═══════════════════════════════════════════════
            COMMAND HERO — FIRST IMPRESSION
            ═══════════════════════════════════════════════ --}}
        <section class="command-hero" aria-label="LSSD Command Center">
            <div class="command-hero-grid"></div>
            <div class="command-hero-glow command-hero-glow-a"></div>
            <div class="command-hero-glow command-hero-glow-b"></div>
            <div class="command-hero-scan"></div>

            <div class="command-hero-content">
                <div class="command-hero-kicker">
                    <span class="command-status-dot"></span>
                    LSSD • LAW ENFORCEMENT COMMAND SYSTEM
                </div>

                <div class="command-hero-main">
                    <div class="command-hero-copy">
                        <h1 class="command-hero-title">
                            DÀNH CHO
                            <span>NHÂN SỰ LSSD - SV1</span>
                        </h1>
                        <p class="command-hero-description">
                            Mọi thông tin nhân sự, chấm công và công cụ hành chính của LLCS LSSD
                            được tập trung trong một trung tâm điều hành duy nhất.
                        </p>
                        {{--
                        <div class="command-hero-actions">
                            <a href="#lssd-features" class="command-btn command-btn-primary">
                                <i class="fa-solid fa-table-cells-large"></i>
                                Khám phá hệ thống
                            </a>
                            <a href="#lssd-officers" class="command-btn command-btn-ghost">
                    ...
                    <div class="command-hero-terminal">
                        <div class="terminal-topbar">
                            <div class="terminal-dots"><span></span><span></span><span></span></div>
                            <span>COMMAND / STATUS</span>
                            <span class="terminal-live"><i></i> ONLINE</span>
                        </div>
                        <div class="terminal-body">
                            <div class="terminal-line"><span class="terminal-key">UNIT</span><span>LLCS-LSSD</span></div>
                            <div class="terminal-line"><span class="terminal-key">ACCESS</span><span>AUTHORIZED</span></div>
                            <div class="terminal-line"><span class="terminal-key">PERSONNEL</span><span>{{ $tongSoNhanVien }} ACTIVE RECORDS</span></div>
                            <div class="terminal-line"><span class="terminal-key">SECURITY</span><span class="terminal-ok">NOMINAL</span></div>
                        </div>
                        <div class="terminal-footer">
                            <span><i class="fa-solid fa-location-crosshairs"></i> LOS SANTOS</span>
                            <span id="lssdLiveClock">--:--:--</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="quick-access" aria-label="Truy cập nhanh">
            <div class="quick-access-heading">
                <div>
                    <span class="features-eyebrow">THAO TÁC NHANH · LLCS</span>
                    <h2>Điểm truy cập</h2>
                </div>
                <span class="quick-access-note"><i class="fa-solid fa-bolt"></i> Sẵn sàng vận hành</span>
            </div>
            <div class="quick-access-grid">
                <a href="{{ route('attendance.index') }}" target="_blank" class="quick-card">
                    <span class="quick-card-icon"><i class="fa-solid fa-clock"></i></span>
                    <span class="quick-card-copy"><strong>Chấm công</strong><small>Quản lý ca trực & thời gian</small></span>
                    <span class="quick-card-arrow">↗</span>
                </a>
                <a href="{{ route('partials.criminal_bail') }}" target="_blank" class="quick-card">
                    <span class="quick-card-icon"><i class="fa-solid fa-file-circle-check"></i></span>
                    <span class="quick-card-copy"><strong>Bảo lãnh tội phạm</strong><small>Tra cứu & xử lý hồ sơ</small></span>
                    <span class="quick-card-arrow">↗</span>
                </a>
                <a href="https://sites.google.com/view/info-gta5vn/b%E1%BB%99-lu%E1%BA%ADt-los-santos?authuser=0" target="_blank" class="quick-card">
                    <span class="quick-card-icon"><i class="fa-solid fa-book-open"></i></span>
                    <span class="quick-card-copy"><strong>Bộ luật Liên bang</strong><small>Quy chuẩn & điều lệ</small></span>
                    <span class="quick-card-arrow">↗</span>
                </a>
                <a href="{{ route('partials.proc_records') }}" target="_blank" class="quick-card">
                    <span class="quick-card-icon"><i class="fa-solid fa-calendar-xmark"></i></span>
                    <span class="quick-card-copy"><strong>Hỗ trợ xử án</strong><small>Gửi yêu cầu hành chính</small></span>
                    <span class="quick-card-arrow">↗</span>
                </a>
            </div>
        </section>
        ...
        {{-- ═══════════════════════════════════════
                ...
                ═══════════════════════════════════════ --}}
        <div class="row g-4 align-items-start" id="lssd-officers">
        ...
        {{-- ═══════════════════════════════════════════
            ...
            ═══════════════════════════════════════════ --}}
        <div class="container features-section mt-5" id="lssd-features">
    ...
    <script>
        ...
        /* ── Live Command Clock ── */
        (function() {
            const clock = document.getElementById('lssdLiveClock');
            if (!clock) return;
